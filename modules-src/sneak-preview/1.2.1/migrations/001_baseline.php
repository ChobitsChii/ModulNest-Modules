...
return new class implements Migration {
    public function key(): string { return 'modulnest.sneak-preview_001_baseline'; }
    public function scope(): string { return 'module'; }
    public function moduleKey(): ?string { return 'modulnest.sneak-preview'; }
    public function description(): string { return 'Sneak-Preview-v2-Baselineschema anlegen.'; }
