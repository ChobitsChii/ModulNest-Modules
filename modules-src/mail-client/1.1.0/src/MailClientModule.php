...
final class MailClientModule implements NativeModuleInterface
{
    ...
    public function nativeBinding(): array
    {
        return [
            ...
            'route_binding'       => 'GET /mail-client, GET /mail-client/compose, GET /mail-client/message, GET/POST /mail-client/accounts/*, GET /mail-client/api/*, POST /mail-client/api/sync/continue',
        ];
    }
}
