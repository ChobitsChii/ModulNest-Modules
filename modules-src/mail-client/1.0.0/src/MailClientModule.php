...
final class MailClientModule implements NativeModuleInterface
{
    ...
    public static function create(ModuleContext $context): ?NativeModuleInterface
    {
        ...
        $syncService     = new ImapSyncService($messageRepo, $folderCacheRepo);
    ...
    public function registerNavigation(
        ...
        // Keine Subnavigation nötig – die gesamte Navigation läuft im 3-Pane-Layout
    }
    ...
    public function nativeBinding(): array
    {
        return [
            ...
            'route_binding'      => 'GET /mail-client, GET /mail-client/compose, GET /mail-client/message, GET/POST /mail-client/accounts/*, GET /mail-client/api/*',
        ];
    }
}
