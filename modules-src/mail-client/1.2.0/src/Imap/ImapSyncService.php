...
final class ImapSyncService
{
    ...
    private const CONTINUE_TIMEOUT    = 15; // 15 Sekunden pro continueSync()-Aufruf für stabilen Hintergrundsync
    ...
    public function getMessages(int $userId, int $accountId, array $accountConn, string $folder, int $limit, int $offset): array
    {
        ...
        // Live-Flags für die aktuell angezeigte Seite mit IMAP synchronisieren
        if (!empty($pageUids)) {
