...
final class AccountRepository
{
    ...
    public function updateSortOrder(int $userId, array $accountIds): void
    {
        $stmt = $this->pdo->prepare('UPDATE mail_client_accounts SET sort_order = :ord WHERE id = :id AND user_id = :uid');
