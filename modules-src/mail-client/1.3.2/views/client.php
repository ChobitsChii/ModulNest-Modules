        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content shadow">
                ...
                <div class="modal-body p-0">
                    <ul class="nav nav-tabs px-3 pt-2 bg-body-tertiary border-bottom" id="mcSettingsTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active py-2 small fw-semibold" id="mc-settings-tab-general" data-bs-toggle="tab" data-bs-target="#mc-settings-pane-general" type="button" role="tab" aria-controls="mc-settings-pane-general" aria-selected="true">
                                <i class="bi bi-sliders me-1"></i> Allgemein &amp; Layout
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link py-2 small fw-semibold" id="mc-settings-tab-whitelist" data-bs-toggle="tab" data-bs-target="#mc-settings-pane-whitelist" type="button" role="tab" aria-controls="mc-settings-pane-whitelist" aria-selected="false" onclick="mailClientApp.loadWhitelist()">
                                <i class="bi bi-shield-check me-1 text-success"></i> Vertraute Absender <span class="badge bg-secondary-subtle text-secondary ms-1" id="mc-whitelist-count">0</span>
                            </button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content p-3">
                        <!-- Tab 1: Allgemein -->
                        <div class="tab-pane fade show active" id="mc-settings-pane-general" role="tabpanel" aria-labelledby="mc-settings-tab-general">
                            <div class="mb-3">
                        ...
                        <!-- Tab 2: Vertraute Absender -->
                        <div class="tab-pane fade" id="mc-settings-pane-whitelist" role="tabpanel" aria-labelledby="mc-settings-tab-whitelist">
                            <p class="text-secondary small mb-3">
                                Externe Bilder werden in E-Mails zum Schutz der Privatsphäre standardmäßig blockiert. Absender oder Domänen auf dieser Liste dürfen externe Bilder automatisch laden.
                            </p>

                            <!-- Hinzufügen-Formular -->
                            <div class="card bg-body-tertiary border mb-3">
                                <div class="card-body p-2">
                                    <form id="mc-whitelist-add-form" onsubmit="event.preventDefault(); mailClientApp.addWhitelistEntry();" class="row g-2 align-items-center">
                                        <div class="col-12 col-md-4">
                                            <select class="form-select form-select-sm" id="mc-whitelist-add-type">
                                                <option value="sender">Einzelner Absender (E-Mail)</option>
                                                <option value="domain">Ganze Domain (z.B. shop.de)</option>
                                            </select>
                                        </div>
                                        <div class="col-12 col-md-5">
                                            <input type="text" class="form-control form-control-sm" id="mc-whitelist-add-val" placeholder="z. B. newsletter@example.com" required>
                                        </div>
                                        <div class="col-12 col-md-3">
                                            <button type="submit" class="btn btn-sm btn-primary w-100" id="mc-whitelist-add-btn">
                                ...
                                <table class="table table-sm table-hover align-middle mb-0" style="font-size: 0.85rem;">
                                    <thead class="table-light sticky-top">
                                        <tr>
                                            ...
                                            <th>Absender / Domain</th>
                                            <th style="width: 140px;">Hinzugefügt</th>
                                            <th style="width: 60px;" class="text-end">Aktion</th>
                                        </tr>
                                    </thead>
                                    <tbody id="mc-whitelist-tbody">
                                        <!-- Dynamisch befüllt via mailClientApp.renderWhitelist -->
                                    </tbody>
                                </table>
                            </div>
                            <div id="mc-whitelist-empty" class="text-center py-4 text-secondary d-none">
                                <i class="bi bi-shield-check" style="font-size: 2rem; opacity: 0.4;"></i>
                                <div class="mt-2 small">Noch keine vertrauten Absender hinterlegt.</div>
                            </div>
                        </div>
                    </div>
                </div>
