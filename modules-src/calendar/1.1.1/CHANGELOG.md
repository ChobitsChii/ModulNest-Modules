...
- TypeError bei Intervall-Eingabe von Serienterminen in CalendarController behoben.
- Automatische dynamische Anpassung der Endzeit im Terminformular implementiert.
- Modul-Icon und Kategorie-Definition im Manifest (module.json) verankert.
